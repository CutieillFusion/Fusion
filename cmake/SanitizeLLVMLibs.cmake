...
# object files and fusion_compiler on the link line—required for static linking.
...
if(NOT FUSION_LLVM_SANITIZE_LOGGED)
  set(FUSION_LLVM_SANITIZE_LOGGED TRUE CACHE INTERNAL "Already logged LLVM sanitize summary")
  list(LENGTH FUSION_LLVM_LIBRARY_PATHS _n_llvm_a)
  list(LENGTH FUSION_LLVM_LIBS_SANITIZED _n_llvm_san)
  message(STATUS "LLVM static libs: ${_n_llvm_a} .a paths, ${_n_llvm_san} sanitized (-l) libs")
endif()
